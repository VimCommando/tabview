...
- [x] 1.1 Add theme/config dependencies and module structure for loading tabview TOML configuration and theme TOML files.
...
- [x] 1.4 Implement theme discovery from `tabview/themes/*.toml` with deterministic theme names from file stems.
- [x] 1.5 Implement selected theme resolution from `config.toml`, with built-in default fallback and fatal errors for missing explicitly selected themes.
...
- [x] 3.1 Add a shipped theme schema or schema documentation for supported TOML fields and style tokens.
...
- [x] 6.2 Add README examples for `config.toml`, theme TOML files, and saved view conditional color rules.
...
- [x] 7.3 Run schema validation or fixture tests for theme TOML and saved view YAML examples.
