...
Define store-backed rendering, bounded initial loading, incremental indexing, lazy-aware operations, status reporting, and reload behavior for large inputs.
