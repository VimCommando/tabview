...
Define format-neutral object interpretation modes and JSON keyed-object table behavior, including detection, projection, stable key identity, schema evolution, incremental access, visibility, and reload.
