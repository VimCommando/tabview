...
Define local SQLite source support, including feature gating, relation selection, bounded read-only queries, typed values, incremental storage, and failure behavior.
